...
| 2026-09-02 | PMB-012 | Progressive enhancement del reveal: script inline añade `js` a `<html>` antes del paint; el CSS oculta un `Reveal` solo bajo `html.js` → sin JS todo visible. React 19 no avisa por clases extra en `<html>`.    |
